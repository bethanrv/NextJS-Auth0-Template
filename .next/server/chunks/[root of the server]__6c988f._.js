...
"[project]/actions/createAccessToken.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function createAccessToken() {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(`${process.env.AUTH0_ISSUER_BASE_URL}/oauth/token`, new URLSearchParams({
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(createAccessToken, "0075db9928ca48174a37ceccba481a63c49aa282a7", null);
}}),
...
"[project]/actions/getUsersRoles.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getUsersRoles() {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSession"])();
    const user = session?.user;
    if (!user) {
        throw new Error("User not authenticated");
    }
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$createAccessToken$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAccessToken"])();
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getUsersRoles, "003ae6c5a82c3607305b60cda85422513808bbf7bb", null);
}}),
"[project]/actions/isUserAdmin.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function isUserAdmin() {
    try {
        const roles = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$getUsersRoles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUsersRoles"])();
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(isUserAdmin, "005e6b59fb01c99ad9662d87becf8a980e3088e6c2", null);
}}),
...
"[project]/app/api/protected/updateEvent/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    // Check admin access
    const isAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$isUserAdmin$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserAdmin"])();
    if (!isAdmin) {
    ...
    try {
        ...
        const { data, error } = await supabase.from("events").update({
            home_team,
            away_team
        }).eq("id", id).select(); // Returns the updated record(s)
        if (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6c988f._.js.map